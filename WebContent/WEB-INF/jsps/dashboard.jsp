					...
					<a href="${pageContext.request.contextPath }/balance" style="text-decoration: none; ">
						<div class="card bg-light mb-3"
							...
							<div class="card-body">
								...
								<p class="card-text">To know your account balance please click here..</p>
							</div>
						</div>
					</a>
				</div>
					...
					<a href="${pageContext.request.contextPath }/settings" style="text-decoration: none; ">
						<div class="card bg-light mb-3"
							...
							<div class="card-body">
								...
								<p class="card-text">Privacy&profile settings please go here </p>
							</div>
						</div>
					</a>
				</div>
					...
					<a href="${pageContext.request.contextPath }/help" style="text-decoration: none; ">
						<div class="card bg-light mb-3"
							...
							<div class="card-body">
								...
								<p class="card-text">Do u have any help related to transfer and deposit or for settings please click here</p>
							</div>
						</div>
					</a>
				</div>
